...
namespace EDMX {
    ...
    class Program {
        ...
        static void CreateEDMXFile(string edmx_dir) {
            var edmx_file = File.ReadAllText(edmx_dir + "DrocsidDbModel.edmx");

            // SSDL file
            var ssdl_file = File.ReadAllLines(edmx_dir + "DrocsidDbModel.ssdl").ToList();
            ...
            // CSDL file
            var csdl_file = File.ReadAllLines(edmx_dir + "DrocsidDbModel.csdl").ToList();
            ...
            // MSL file
            var msl_file = File.ReadAllLines(edmx_dir + "DrocsidDbModel.msl").ToList();
            ...
            // Override EDMX
            File.WriteAllText(edmx_dir + "DrocsidDbModel.edmx", edmx_file);
        }

        static void ModifyNavigationProperties(string edmx_dir, string script_filepath) {
            var edmx_file = File.ReadAllLines(edmx_dir + "DrocsidDbModel.edmx");
            ...
            File.WriteAllLines(edmx_dir + "DrocsidDbModel.edmx", edmx_file);
        }
